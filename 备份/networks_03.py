...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.PBN1 = PBN(1024, num_classes, do_reduction=True, num_reduction=256)

        # global branch
        self.PBN2 = PBN(2048, num_classes, do_reduction=True, num_reduction=256) # 到这来
        ...
        self.PBN_l1 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)
        self.PBN_l2 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)
        self.PBN_l3 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)
        ...
        self.PBN_l4 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)
        self.PBN_l5 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)
        self.PBN_l6 = PBN(2048, num_classes, do_reduction=True, num_reduction=256)        
