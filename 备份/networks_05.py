...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.PBN1 = PBN(1024, num_classes, do_reduction=False, num_reduction=1024)

        # global branch
        self.PBN2 = PBN(2048, num_classes, do_reduction=True, num_reduction=1024) # 到这来
        ...
        self.PBN_l1 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)
        self.PBN_l2 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)
        self.PBN_l3 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)
        ...
        self.PBN_l4 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)
        self.PBN_l5 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)
        self.PBN_l6 = PBN(2048, num_classes, do_reduction=True, num_reduction=512)        
    ...
    def forward(self, x):
        ...
        # divided three parts
        height1 = x_p1_1.shape[2]
        x_p1_1_1 = x_p1_1[:, :, :int(height1/3), :]
        x_p1_1_2 = x_p1_1[:, :, int(height1/3):int(2*height1/3), :]
        x_p1_1_3 = x_p1_1[:, :, int(2*height1/3):, :]
        # part1的part1
        x_p1_1_1 = self.bt1(x_p1_1_1)
        x_p1_1_1_t, x_p1_1_1_i, x_p1_1_1_s = self.PBN_l1(x_p1_1_1)
        # part1的part2
        x_p1_1_2 = self.bt2(x_p1_1_2)
        x_p1_1_2_t, x_p1_1_2_i, x_p1_1_2_s = self.PBN_l2(x_p1_1_2)
        # part1的part3
        x_p1_1_3 = self.bt3(x_p1_1_3)
        x_p1_1_3_t, x_p1_1_3_i, x_p1_1_3_s = self.PBN_l3(x_p1_1_3)

        # -------------------------- part2 分支 ---------------------
        x_p2_1 = self.bottleneck3(x_p2)
        x_p2_1_1 = x_p2_1[:, :, :int(height1/3), :]
        x_p2_1_2 = x_p2_1[:, :, int(height1/3):int(2*height1/3), :]
        x_p2_1_3 = x_p2_1[:, :, int(2*height1/3):, :]
        # part2的part1
        x_p2_1_1 = self.bt1(x_p2_1_1)
        x_p2_1_1_t, x_p2_1_1_i, x_p2_1_1_s = self.PBN_l4(x_p2_1_1)
        # part2的part2
        x_p2_1_2 = self.bt2(x_p2_1_2)
        x_p2_1_2_t, x_p2_1_2_i, x_p2_1_2_s = self.PBN_l5(x_p2_1_2)
        # part2的part3
        x_p2_1_3 = self.bt3(x_p2_1_3)
        x_p2_1_3_t, x_p2_1_3_i, x_p2_1_3_s = self.PBN_l6(x_p2_1_3)        
        ...
        # add part1 feature
        # part1_1
        softmax_features.append(x_p1_1_1_s)
        triplet_features.append(x_p1_1_1_t)
        predict.append(x_p1_1_1_i)
        # part1_2
        softmax_features.append(x_p1_1_2_s)
        triplet_features.append(x_p1_1_2_t)
        predict.append(x_p1_1_2_i)
        # part1_3
        softmax_features.append(x_p1_1_3_s)
        triplet_features.append(x_p1_1_3_t)
        predict.append(x_p1_1_3_i)        

        # add part2 feature
        # part2_1
        softmax_features.append(x_p2_1_1_s)
        triplet_features.append(x_p2_1_1_t)
        predict.append(x_p2_1_1_i)   
        # part2_2
        softmax_features.append(x_p2_1_2_s)
        triplet_features.append(x_p2_1_2_t)
        predict.append(x_p2_1_2_i)
        # part2_3
        softmax_features.append(x_p2_1_3_s)
        triplet_features.append(x_p2_1_3_t)
        predict.append(x_p2_1_3_i)                       
