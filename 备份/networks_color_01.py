...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.PBN1_1 = PBN_modify(1024, num_classes, num_reduction=512) # 到这来

        self.PBN2 = PBN_modify(2048, num_classes, num_reduction=512)
        self.PBN2_1 = PBN_modify(1024, num_classes, num_reduction=512)
        self.convbn = Conv_BN(2048, num_classes, num_reduction=512)
