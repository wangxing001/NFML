...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.PBN1 = PBN_modify(1024, num_classes, do_reduction=True, num_reduction=256)

        # global branch
        self.PBN2 = PBN_modify(2048, num_classes, do_reduction=True, num_reduction=256) # 到这来
